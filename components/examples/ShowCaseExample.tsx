...
export default function SwitchExample() {
  ...
  return ( 
    <ShowCase images={showCaseImages} width='100%' height='100%' />
  )
}
`;

const Arrow360 = ()=><svg className='absolute top-24 left-24' fill="currentColor" width={50} x="0px" y="0px" viewBox="0 0 122.88 61.49" xmlSpace="preserve">
...
export default function ShowCaseExample() {
  ...
  return (
    <div className="flex flex-col h-full example relative">
      <Arrow360 />
      <div className="m-4 h-80 scale-150 -mt-14">
        <ShowCase images={showCaseImages} initialImage={14} width='100%' height='100%' />
      </div>
      <div className='flex justify-center'>
        <Code inner={inner} css={{ width: "600px" }} />
      </div>
    </div>
  );
}